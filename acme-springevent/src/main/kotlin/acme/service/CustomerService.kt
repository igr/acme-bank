...
class CustomerService(
    ...
    fun getCurrentCustomer(customerId: UUID): CustomerDto? {
        return customerRepository.findById(customerId)
            .map { customer -> CustomerDto(customer.customerId, customer.name) }
            .orElse(null)
    }
    
    fun getCustomerAccounts(customerId: UUID): List<AccountDto> {
    ...
    fun getTotalAccountsAmount(): Long {
